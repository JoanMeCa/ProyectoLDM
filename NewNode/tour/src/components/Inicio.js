...
const Inicio = () => {
  return (
    <div className="container text-center"> {/* Agregado container y text-center */}
      <h2>Bienvenido a la Ciudad</h2>
      <p>Descubre todo lo que nuestra ciudad tiene para ofrecer.</p>
...
Drifting in the ocean all alone</p>
    </div>
  );
}
